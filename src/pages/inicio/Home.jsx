...
import mobileImg from '../../assets/img/Mobile Phone.png';
import watchImg from '../../assets/img/smart watch.png';
import headphoneImg from '../../assets/img/headphone.png';
import cpuImg from '../../assets/img/cpu heat.jpg';
              ...
              return (
                <div className='productbox' key={curElm.id}>
                  ...
                  <div className='detail'>
                    ...
                    <h2>{curElm.Title}</h2>
                    <p>
                      A Screen Everyone Will Love: Whether your family is streaming or video chatting with friends tablet
                      A8...
                    </p>
                    <h3>{curElm.Price}</h3>
